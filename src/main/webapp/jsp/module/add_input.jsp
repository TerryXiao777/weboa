...
<script type="text/javascript" src="<%=path%>/js/module/add_input.js"></script>
</head>
    ...
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td>
	        <form action="module.do" method="post" id="moduleForm">
	        	<input type="hidden" name="method" value="add">
				<input type="hidden" name="parentId" value="${moduleForm.parentId}"/>
				<input type="hidden" name="skipUrl" value="module.do?method=moduleList">
		        <table width="100%" border="0" cellpadding="0" cellspacing="1">
		          <tr>
		          	<td class="STYLE6" width="10%">模块名称：</td>
		          	<td width="15%">
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">模块编号：</td>
		          	<td width="15%">
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">排序号：</td>
		          	<td width="15%">
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">模块地址：</td>
		          	<td width="15%">
		          ...
		          <tr>
		          	<td colspan="3">
		          		<div class="div_img1">
			          		<a href="javascript:void(0);" id="doSubmit"><img src="images/btn_01.png" border="0" id="btn_ok"/></a>
