            ...
            <td width="46%" valign="middle">
	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              <tr>
	                ...
	                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[权限管理]-[模块管理]</td>
	              </tr>
	            </table>
            </td>
            <td width="54%">
                ...
                <td width="60">
	                <table width="90%" border="0" cellpadding="0" cellspacing="0">
	                  <tr>
	                    ...
	                    <td class="STYLE1"><div align="center"><a href="module.do?method=addInput&parentId=${moduleForm.parentId}" class="a1">新增</a></div></td>
	                  </tr>
	                </table>
                </td>
                ...
                <td width="60">
	                <table width="90%" border="0" cellpadding="0" cellspacing="0">
	                  <tr>
	                    ...
	                    <td class="STYLE1"><div align="center"><a href="module.do?method=moduleList&parentId=0" class="a1">返回</a></div></td>
	                  </tr>
	                </table>
                </td>
                <!--  
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto();" onmouseout="changeback();" id="resultTable">
          ...
          <tr>
            ...
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">模块名称</span></div></td>
            <td width="14%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">模块编号</span></div></td>
	      ...
	      <tr>
		      <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">${module.id }</div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">
	          	<a class="a1" href="module.do?method=moduleList&parentId=${module.id }">${module.name }</a></span></div>
	          </td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <pg:pager url="module.do" items="${pm.total}" maxPageItems="${ps}" export="currentPageNumber=pageNumber">
