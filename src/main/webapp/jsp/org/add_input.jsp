...
<script type="text/javascript" src="<%=path%>/js/org/add_input.js"></script>
</head>
    ...
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td>
	        <form action="org.do" method="post" id="orgForm">
	        	<input type="hidden" name="method" value="add">
				<input type="hidden" name="parentId" value="${orgForm.parentId}"/>
				<input type="hidden" name="skipUrl" value="org.do?method=orgList">
		        <table width="100%" border="0" cellpadding="0" cellspacing="1">
		          <tr>
		          	<td class="STYLE6" width="10%">机构名称：</td>
		          	<td width="15%">
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">机构描述：</td>
		          	<td width="15%">
