      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto();" onmouseout="changeback();" id="resultTable">
          ...
          <tr>
            ...
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">机构名称</span></div></td>
            <td width="14%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">机构编号</span></div></td>
            <td width="18%" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">父机构名称</span></div></td>
	      ...
	      <tr>
		      <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">${org.id }</div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1"><a class="a1" href="org.do?method=orgList&parentId=${org.id }">${org.name }</a></span></div></td>
	          ...
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE4">
	          	<a href="#" class="a1" onclick="javascript:del('org.do?method=del&id=${org.id }')" >删除</a></span></div>
	          </td>
          </tr>
          </c:forEach>
		  </c:if>
