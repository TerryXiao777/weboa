...
<script type="text/javascript" src="<%=path%>/js/user/add_input.js"></script>
</head>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <form action="user.do" method="post" id="userForm">
				...
				<input type="hidden" name="skipUrl" value="user.do?method=userList">
		        <table width="100%" border="0" cellpadding="0" cellspacing="1">
		          <tr>
		          	<td class="STYLE6" width="10%">用户账号：</td>
		          	<td width="15%">
		          		<input type="text" id="username" name="username" value="${user.username }" onblur="check();"/>&nbsp;
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">登录密码：</td>
		          	<td width="15%">
		          		<input type="password" id="password" name="password" value="${user.password }" onblur="check();"/>&nbsp;
		          		<span class="STYLE7"></span>
		          	</td>
		          	<td width="75%">
		          		<div class="success" id="msg_succ" style="display: none"></div>
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">失效时间：</td>
		          	<td width="15%">
		          		<input type="text" id="expireTime" name="expireTime" onblur="check();" value="<fmt:formatDate value="${user.expireTime }" pattern="yyyy-MM-dd"/>"/>&nbsp;
		          		<span class="STYLE7"></span>
		          	</td>
		          	<td width="75%">
		          		<div class="success" id="msg_succ" style="display: none"></div>
