            ...
            <td width="46%" valign="middle">
	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              <tr>
	                ...
	                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[权限管理]-[用户管理]</td>
	              </tr>
	            </table>
            </td>
            <td width="54%">
                ...
                <td width="60">
	                <table width="90%" border="0" cellpadding="0" cellspacing="0">
	                  <tr>
	                    ...
	                    <td class="STYLE1"><div align="center"><a href="user.do?method=addInput" class="a1">新增</a></div></td>
	                  </tr>
	                </table>
                </td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto();" onmouseout="changeback();" id="resultTable">
          ...
          <tr>
            ...
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">性别</span></div></td>
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">所属机构</span></div></td>
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">登录账号</span></div></td>
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">失效时间</span></div></td>
	      ...
	      <tr>
		      <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">${person.id }</div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${person.name }</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${person.sex }</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${person.org.name }</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${person.user.username }</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1"><fmt:formatDate value="${person.user.expireTime }" pattern="yyyy-MM-dd"/></span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE4">
	          	<a href="user.do?method=addInput&personId=${person.id }" class="a1" >分配帐号</a>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <pg:pager url="user.do" items="${pm.total}" maxPageItems="${ps}" export="currentPageNumber=pageNumber">
          <tr>
