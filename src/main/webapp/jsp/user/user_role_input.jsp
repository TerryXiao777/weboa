...
<script type="text/javascript" src="<%=path%>/js/user/user_role_list.js"></script>
</head>
...
<input type="hidden" name="skipUrl" value="user.do?method=userRoleList&id=${userForm.id}">
            ...
            <td width="75%" valign="middle">
	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              <tr>
	                ...
	                <td width="40%"><span class="STYLE3">请选择要分配给用户的角色</span></td>
	              </tr>
	            </table>
            </td>
            <td width="25%">
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto();" onmouseout="changeback();" id="resultTable">
          ...
          <tr>
            ...
            <td width="33%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">选择</span></div></td>
          ...
          <c:forEach items="${pm.datas }" var="role">
		      <tr>
			      <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1"><input type="radio" name="roleId" value="${role.id }"></div></td>
  ...
  <tr>
    <td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
          <tr>
          	<td class="STYLE6" width="10%">优先级：</td>
          	<td width="15%">
          		<input type="text" id="orderNo" name="orderNo" onblur="check();"/>&nbsp;
