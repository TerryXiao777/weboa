              ...
              <tr>
                ...
                <td width="60">
	                <table width="90%" border="0" cellpadding="0" cellspacing="0">
	                  <tr>
	                    ...
	                    <td class="STYLE1"><div align="center"><a href="document.do?method=addInput" class="a1">新增</a></div></td>
	                  </tr>
	                </table>
                </td>
                ...
                <td width="120">
	                <table width="90%" border="0" cellpadding="0" cellspacing="0">
	                  <tr>
	                    <td class="STYLE1"><div align="center"><img src="images/tab/22.gif" width="14" height="14" /></div></td>
	                    <td class="STYLE1"><div align="center"><a href="document.do?method=selectFlow" class="a1">添加公文信息</a></div></td>
	                  </tr>
	                </table>
                </td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto();" onmouseout="changeback();" id="resultTable">
          ...
          <tr>
            ...
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">公文名称</span></div></td>
            <td width="14%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">公文描述</span></div></td>
            <td width="14%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">创建时间</span></div></td>
            <td width="14%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">公文状态</span></div></td>
            <td width="10%" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">流程名称</span></div></td>
            <td width="10%" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">附件</span></div></td>
            <td width="10%" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">审批历史</span></div></td>
	      ...
	      <tr>
		      <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">${document.id }</div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${document.title }</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${document.description }</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${document.createTime }</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${document.status}</span></div></td>
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${document.workflow.name }</span></div></td>
	          ...
	          <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE4">
	          	<a href="person.do?method=updateInput&id=${person.id }" class="a1">更新</a>
	          	<a href="#" class="a1" onclick="javascript:del('person.do?method=del&id=${person.id }')" >删除</a>
	          	</span></div>
	          </td>
          </tr>
          </c:forEach>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <pg:pager url="document.do" items="${pm.total}" maxPageItems="${ps}" export="currentPageNumber=pageNumber">
          <tr>
