...
<script type="text/javascript" src="<%=path%>/js/document/add_input.js"></script>
</head>
    ...
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td>
	        <form action="document.do" method="post" id="documentForm" enctype="multipart/form-data">
	        	<input type="hidden" name="method" value="add">
				<input type="hidden" name="skipUrl" value="document.do?method=personList">
				<input type="hidden" name="workflowId" value="${documentForm.workflowId}">
		        <table width="100%" border="0" cellpadding="0" cellspacing="1">
		          
		          <tr>
		          	<td class="STYLE6" width="10%">公文名称：</td>
		          	<td width="15%">
		          		<input type="text" id="title" name="title" onblur="check();"/>&nbsp;
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">公文描述：</td>
		          	<td width="15%">
		          		<input type="text" id="description" name="description" onblur="check();"/>&nbsp;
		          		<span class="STYLE7"></span>
		          	</td>
		          	<td width="75%">
		          		<div class="success" id="msg_succ" style="display: none"></div>
		          ...
		          <tr>
		          	<td class="STYLE6" width="10%">公文附件：</td>
		          	<td width="15%">
